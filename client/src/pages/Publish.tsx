...
export function Publish() {
    ...
    async function postBlog() {
        try {
            ...
            console.log(e);
            alert("Unable to publish blog post.");
        }
    }

    return <div>
        <div className="flex justify-center">
            <div className="max-w-screen-lg w-screen pt-8">
                ...
                <div className="my-8"><TextEditor onChange={(e) => {
                    setContent(e.target.value);
                }}></TextEditor></div>
                <button onClick={postBlog} type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                    Publish post
                </button>
            </div>
        </div>
        ...
        <form>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea onChange={onChange} id="editor" className="h-52 block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
                </div>
            </div>
        </form>
    </div>
