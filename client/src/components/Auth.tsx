    ...
    return (<div className="h-screen flex justify-content flex-col">
        <div className="h-screen flex justify-center place-items-center">
            <div>
                ...
                {type === "signup" ? <LabelledInput label="Name" placeholder="Donald Trump" onChange={(e) => {
                    setPostInputs((c) => ({
                        ...c,
                        name: e.target.value
                    }))
